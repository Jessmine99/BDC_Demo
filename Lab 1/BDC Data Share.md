...
{: .warning }
This section cannot be performed within the workshop environment.**HANA Data Like File Storage capacity is a prerequisite.**The steps below are provided for informational purposes to explain the process. Use the clickable demo to better understand the process and the required steps.
