...
**Interpretation**: Invoiced revenue is different across sales organizations.
...
- Dimensions: `accounttype`  
- Color: `accounttype`  
- Add filter : Choose premium products --> Set dimension context to SOLD_TO_CUSTOMER --> Range: Greater than or equal to 1 --> Click Set
- Double click on the chart title and change it to: `Total revenue generated by premium products for each account type.`

<p>
  <img
    src="{{ site.baseurl }}/images/premium_chart.png"
    alt="premium_chart"
    style="width:400px; cursor:pointer;"
    onclick="document.getElementById('img69').showModal()"
  >
</p>

<dialog id="img69" onclick="if(event.target===this)this.close()">
  <img src="{{ site.baseurl }}/images/premium_chart.png" style="max-width:90vw;">
</dialog>
...
**Interpretation**: Monitoring customers generate most of the revenue from premium products. Strategic customers contribute a moderate amount, while Target customers generate the least and represent potential for future growth. This suggests that customers tend to buy premium products after they have built a stable relationship with the company.
